...
import { pokemonMockData } from '@/lib/mockData/pokemon'
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex justify-between items-center mb-4">
            <div>
              ...
              <h1 className="text-4xl font-bold text-yellow-accent mt-2">Pokémon TCG</h1>
            </div>
            <LanguageToggle />
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="card">
              <div className="flex justify-between items-center mb-4">
                ...
                <CSVImporter tcgName="Pokémon" cards={pokemonMockData} />
              </div>
              <CardSearch
                cards={pokemonMockData}
            ...
            {selectedCard && (
              <>
                ...
                <CardDisplay card={selectedCard} tcgName="Pokémon" />
              </>
            )}
          </div>
