...
import { yugiohMockData } from '@/lib/mockData/yugioh'

function YugiohPageContent() {
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex justify-between items-center mb-4">
            <div>
              ...
              <h1 className="text-4xl font-bold text-yellow-accent mt-2">Yu-Gi-Oh! TCG</h1>
            </div>
            <LanguageToggle />
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="card">
              <div className="flex justify-between items-center mb-4">
                ...
                <CSVImporter tcgName="Yu-Gi-Oh!" cards={yugiohMockData} />
              </div>
              <CardSearch
                cards={yugiohMockData}
            ...
            {selectedCard && (
              <>
                ...
                <CardDisplay card={selectedCard} tcgName="Yu-Gi-Oh!" />
              </>
            )}
          </div>
